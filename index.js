...
/////////////////
const BotName = 'WILLI BOT☄'; 


const kapanbotaktif = 'HARUS BILANG WILLI'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@Willi.Sins')
